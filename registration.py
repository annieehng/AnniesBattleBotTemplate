...
try:
    registration = requests.post(base_url + '/' + str(team_type) + '/session/' + str(session_id) + '/register', headers=header, data=json.dumps({"github_url": "https://github.com/annieehng/AnniesBattleBotTemplate", "github_branch": "FRdetector", "env_var1": "", "env_var2": ""}))
